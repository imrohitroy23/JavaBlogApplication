...
public class PostController {
  ...
  @GetMapping("/posts")
  public ResponseEntity<PostResponse> getPostsAll(@RequestParam(value = "pageNumber",defaultValue = "0", required = false) Integer pageNumber,@RequestParam(value = "pageSize",defaultValue = "10", required = false) Integer pageSize,

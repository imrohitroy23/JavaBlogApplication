...
public class CategoryController {
    ...
    private CategoryService userService;
     @PostMapping("/")
    public ResponseEntity<CategoryDto> createdUser(@Valid @RequestBody CategoryDto category){
    ...
    public ResponseEntity<CategoryDto> updateUser(@Valid @RequestBody CategoryDto category, @PathVariable Integer categoryId){
